...
import { getAttributeById, updateProfile } from "../../../@core/api/common_api";
  ...
  return (
    <Fragment>
      <div className="content-header mb-2">
        <h2 className="fw-bolder mb-75">Extra Information</h2>
        <span>Enter Extra details</span>
      </div>
                ...
                <div className="demo-inline-spacing">
                  ...
                  >
                    <Input
                      ...
                      {...field}
                      value="1"
                      checked={registerData?.kmc_work_area == 1}
                      onChange={(e) => {
                        field.onChange(e?.target?.value);
                        onHandleChange(e?.target?.value, e?.target?.name);
                      }}
                  ...
                  >
                    <Input
                      ...
                      {...field}
                      value="0"
                      checked={registerData?.kmc_work_area == 0}
                      onChange={(e) => {
                        field.onChange(e?.target?.value);
                        onHandleChange(e?.target?.value, e?.target?.name);
                      }}
                ...
                <div className="demo-inline-spacing">
                  ...
                  >
                    <Input
                      ...
                      {...field}
                      value="1"
                      checked={registerData?.kmc_to_children == 1}
                      onChange={(e) => {
                        field.onChange(e?.target?.value);
                        onHandleChange(e?.target?.value, e?.target?.name);
                      }}
                  ...
                  >
                    <Input
                      ...
                      {...field}
                      value="0"
                      checked={registerData?.kmc_to_children == 0}
                      onChange={(e) => {
                        field.onChange(e?.target?.value);
                        onHandleChange(e?.target?.value, e?.target?.name);
                      }}
                  ...
                  >
                    <Input
                      ...
                      {...field}
                      value="2"
                      checked={registerData?.kmc_to_children == 2}
                      onChange={(e) => {
                        field.onChange(e?.target?.value);
                        onHandleChange(e?.target?.value, e?.target?.name);
                      }}
